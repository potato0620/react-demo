...
const initThree = (canvas: HTMLCanvasElement) => {
  ...
  const cube1 = new THREE.Mesh(new THREE.SphereGeometry(0.5, 64, 64), envMaterial)
  // cube1.position.x = -1.5;
  cube1.geometry.setAttribute(
    'uv2',
    new THREE.BufferAttribute(cube1.geometry.attributes.uv.array, 2)
  )

  const cube2 = new THREE.Mesh(new THREE.PlaneGeometry(1, 1, 100, 100), envMaterial)
  ...
  const cube3 = new THREE.Mesh(new THREE.TorusGeometry(0.3, 0.2, 64, 128), envMaterial)

  cube3.position.x = 1.5
  cube3.geometry.setAttribute(
    'uv2',
    new THREE.BufferAttribute(cube3.geometry.attributes.uv.array, 2)
  )
